...
class TitanStrategy:
    def __init__(self):
        ...
        # - pullback 허용 범위
        # - continuation 확인 폭
        #  18,2.5,12,20,125,4,0.8500000000000001,0.06
        # =====================================================================
        self.params = {
            "atr_period": 18,
            "atr_multiplier": 2.5,
    ...
    def calculate_indicators(self, symbol, df):
        ...
        # =========================================================
        # 2) Daily EMA Placeholder
        # - 실제 권위 daily EMA는 엔진(live/backtest)이 1d context로 주입한다.
        # - 전략 내부의 15m -> D resample 계산은 제거한다.
        # =========================================================
        df["ema_daily"] = 0.0
        df["ema_daily_ok"] = 0
