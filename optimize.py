...
if __name__ == "__main__":
    ...
    for i, (view_name, trial_id, params) in enumerate(picked, start=1):
        ...
        run_one_and_export(raw_cache, universe, params, view_dir, tag=tag, days=30)
    ...
    run_one_and_export(raw_cache, universe, best_params, best_out, tag="best", days=30)

    print("📌 Exporting BASELINE report...")
    run_one_and_export(raw_cache, universe, baseline_params, base_out, tag="baseline", days=30)
